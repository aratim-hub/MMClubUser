...
import com.appmart.mmcuser.activities.QASection;
...
public class MMC_QA extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new Atomy_QAListAdapter(getContext(), data_list, MMC_QA.this);
