...
public class SpoonserTrainigTestActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_spoonser_trainig_test);
        ...
        btn_continue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final int index = Integer.valueOf(SharedPref.getString(SpoonserTrainigTestActivity.this,"sponser_test_index"));
...
//                            startActivity(new Intent(getApplicationContext(),Home.class));
                            ...
                            AlertDialog.Builder builder = new AlertDialog.Builder(SpoonserTrainigTestActivity.this);
...
//                           builder.setTitle("");
                            ...
                            MoreDetails.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    progressDialog.show();
                                    GoToNextVedio(x);
//                                   SharedPref.putString(BusinessTrainingVedioTestActivity.this,"sponser_test_index",String.valueOf(x + 1));
...
//                        .add("company", "MMC")
                ...
                okhttp3.Request request = new okhttp3.Request.Builder()
                        .url(SUBMIT_SPONSER_TRAINING_VIDEO)
                        .post(requestBody)
                        .build();
...
//                    }
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                SharedPref.putString(SpoonserTrainigTestActivity.this,"sponser_test_index",String.valueOf(index + 1));
    ...
    private void getAllAnswers(int index) {
        ...
        AsyncTask<Integer, Void, Void> task = new AsyncTask<Integer, Void, Void>() {
            ...
            protected Void doInBackground(Integer... integers) {
                ...
                okhttp3.Request request = new okhttp3.Request.Builder()
                        .url(SUBMIT_SPONSER_TRAINING_VIDEO_STATUS)
                        .post(requestBody)
                        .build();
...
//        }
    ...
    private void load_data_from_server() {
        ...
        AsyncTask<Integer, Void, Void> task = new AsyncTask<Integer, Void, Void>() {
            ...
            protected Void doInBackground(Integer... integers) {
                ...
                okhttp3.Request request = new okhttp3.Request.Builder()
                        .url(GET_SPONSOR_TRAINING_VIDEO)
                        .post(requestBody)
                        .build();
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                if (data_list != null){
                    if (data_list.size() != 0){
                        loadQuesions(data_list.get(Integer.valueOf(SharedPref.getString(SpoonserTrainigTestActivity.this,"sponser_test_index"))));
                    }else{
                        Toast.makeText(SpoonserTrainigTestActivity.this, "data not found", Toast.LENGTH_SHORT).show();
                    }
                }else{
                    Toast.makeText(SpoonserTrainigTestActivity.this, "data not found", Toast.LENGTH_SHORT).show();
                }
    ...
    private void loadQuesions(AtomyTrainingVideoListData item) {
        youTubeView.initialize(YoutubeConfig.YOUTUBE_API_KEY, SpoonserTrainigTestActivity.this);
            ...
            try {
                ...
                if (jsonArray.length()!=0){
                    for (int i=0; i<jsonArray.length(); i++){
                        ...
                        videoQuestionList.setTv_id(jsonObject.getString("stv_id"));
