...
import static com.appmart.mmcuser.utils.ServerAddress.SUBMIT_GREAT_SPONSER_TRAINING_VIDEO;
import static com.appmart.mmcuser.utils.ServerAddress.SUBMIT_GREAT_SPONSER_TRAINING_VIDEO_STATUS;
import static com.appmart.mmcuser.utils.ServerAddress.SUBMIT_SPONSER_TRAINING_VIDEO;
import static com.appmart.mmcuser.utils.ServerAddress.SUBMIT_SPONSER_TRAINING_VIDEO_STATUS;

public class GreatSponserTrainingTestActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_great_sponser_training_test);
        ...
        btn_continue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final int index = Integer.valueOf(SharedPref.getString(GreatSponserTrainingTestActivity.this,"great_sponser_test_index"));
...
//                            startActivity(new Intent(getApplicationContext(),Home.class));
                            ...
                            AlertDialog.Builder builder = new AlertDialog.Builder(GreatSponserTrainingTestActivity.this);
...
//                           builder.setTitle("");
                            ...
                            MoreDetails.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    progressDialog.show();
                                    GoToNextVedio(x);
//                                   SharedPref.putString(BusinessTrainingVedioTestActivity.this,"great_sponser_test_index",String.valueOf(x + 1));
...
//                        .add("company", "MMC")
                ...
                okhttp3.Request request = new okhttp3.Request.Builder()
                        .url(SUBMIT_GREAT_SPONSER_TRAINING_VIDEO)
                        .post(requestBody)
                        .build();
...
//                    }
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                SharedPref.putString(GreatSponserTrainingTestActivity.this,"great_sponser_test_index",String.valueOf(index + 1));
    ...
    private void getAllAnswers(int index) {
        ...
        AsyncTask<Integer, Void, Void> task = new AsyncTask<Integer, Void, Void>() {
            ...
            protected Void doInBackground(Integer... integers) {
                ...
                okhttp3.Request request = new okhttp3.Request.Builder()
                        .url(SUBMIT_GREAT_SPONSER_TRAINING_VIDEO_STATUS)
                        .post(requestBody)
                        .build();
...
//        }
        ...
        AsyncTask<Integer, Void, Void> task = new AsyncTask<Integer, Void, Void>() {
            ...
            protected Void doInBackground(Integer... integers) {
                ...
                try {
                    ...
                    JSONArray array = new JSONArray(response.body().string());
                    Log.i("TAG", "doInBackground: "+array);

                    for (int i = 0; i < array.length(); i++) {
                        JSONObject object = array.getJSONObject(i);
                        AtomyTrainingVideoListData data = new AtomyTrainingVideoListData(
                                object.getString("gstv_id"),
                                object.getString("video_title"),
                                object.getString("video_desc"),
                                object.getString("video_url"),
                                object.getString("video_url_id"),
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                if (data_list != null){
                    if (data_list.size() != 0){
                        loadQuesions(data_list.get(Integer.valueOf(SharedPref.getString(GreatSponserTrainingTestActivity.this,"great_sponser_test_index"))));
                    }else{
                        Toast.makeText(GreatSponserTrainingTestActivity.this, "data not found", Toast.LENGTH_SHORT).show();
                    }
                }else{
                    Toast.makeText(GreatSponserTrainingTestActivity.this, "data not found", Toast.LENGTH_SHORT).show();
                }
    ...
    private void loadQuesions(AtomyTrainingVideoListData item) {
        youTubeView.initialize(YoutubeConfig.YOUTUBE_API_KEY, GreatSponserTrainingTestActivity.this);
            ...
            try {
                ...
                if (jsonArray.length()!=0){
                    for (int i=0; i<jsonArray.length(); i++){
                        ...
                        videoQuestionList.setTv_id(jsonObject.getString("gstv_id"));
