...
import com.appmart.mmcuser.multiSuccess.model.SwissGoldListData;
...
public class SwissGoldListAdapter extends RecyclerView.Adapter<SwissGoldListAdapter.ViewHolder> {

    private Context context;
    private List<SwissGoldListData> my_data;

    public SwissGoldListAdapter(Context context, List<SwissGoldListData> dataReceived) {
