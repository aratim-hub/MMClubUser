...
public class NexMoneyListAdapter extends RecyclerView.Adapter<NexMoneyListAdapter.ViewHolder> {

    private Context context;
    private List<NexMoneyListData> my_data;

    public NexMoneyListAdapter(Context context, List<NexMoneyListData> dataReceived) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        if (my_data.get(position).getMsuccess_image_url().contains(".jpg") || my_data.get(position).getMsuccess_image_url().contains(".png")|| my_data.get(position).getMsuccess_image_url().contains(".jpeg")) {
