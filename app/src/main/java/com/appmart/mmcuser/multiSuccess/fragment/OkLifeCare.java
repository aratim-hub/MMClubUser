...
public class OkLifeCare extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.frag_oklifecare, container, false);
...
//                    ConstantMethods.showAlertMessege(getContext(), "Coming Soon", "MMC Will inform you once it enabled");
                ...
                try {
                    ...
                    String url = "https://oklifecare.com/Home.aspx";
...
//                }
                ...
                i.putExtra("CompanyName", "OkLifeCare");
                startActivity(i);
//                ConstantMethods.showAlertMessege(getContext(), "Coming Soon", "MMC Will inform you once it enabled");
...
// disable buttons if already joined and approved
        mySponsorId = My_Links_SharedPref.getInstance(getContext()).getOKLIFECARE_MY_LINK();
        ...
        AsyncTask<Integer, Void, Void> task = new AsyncTask<Integer, Void, Void>() {
            ...
            protected Void doInBackground(Integer... integers) {
                ...
                Request request = new Request.Builder()
                        .url(GET_ALL_NEX_MONEY_MULTISUCCESS + "?company=OkLifeCare")
                        .build();
                try {
