...
public class GIGListAdapter extends RecyclerView.Adapter<GIGListAdapter.ViewHolder> {

    private Context context;
    private List<RenatusNovaListData> my_data;

    public GIGListAdapter(Context context, List<RenatusNovaListData> dataReceived) {
