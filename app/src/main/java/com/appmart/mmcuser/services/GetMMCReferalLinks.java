...
public class GetMMCReferalLinks extends Service {

    public static HashMap<String,String> MMC_LINKS=new HashMap<>();
    @Nullable
    @Override
    ...
    private void getHostDetails() {
        ...
        AsyncTask<Integer, Void, Void> task = new AsyncTask<Integer, Void, Void>() {
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                String NexMoey_mmc_Link = MMC_LINKS.get("NexMoney");
                String OkLifeCare_mmc_Link = MMC_LINKS.get("OkLifeCare");

                MMC_Referal_Links_SharedPref.getInstance(getApplicationContext()).saveMMCLinks(NexMoey_mmc_Link,OkLifeCare_mmc_Link);
                GetMMCReferalLinks.super.onDestroy();
            }
        };
