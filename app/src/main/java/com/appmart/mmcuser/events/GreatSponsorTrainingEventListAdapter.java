...
public class GreatSponsorTrainingEventListAdapter extends RecyclerView.Adapter<GreatSponsorTrainingEventListAdapter.ViewHolder> {

    GreatSponsorTrainingEventList eventList;
    private Context context;
    private List<GreatSponsorTrainingEventListData> my_data;
    private Handler handler = new Handler();

    public GreatSponsorTrainingEventListAdapter(Context context, List<GreatSponsorTrainingEventListData> dataReceived, GreatSponsorTrainingEventList eventList) {
...
String cid=my_data.get(position).getController_id();
//            Toast.makeText(context, "sss"+cid, Toast.LENGTH_SHORT).show();
        }
    }
