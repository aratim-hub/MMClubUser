...
public class GreatSponsorTrainingEventListData {
    ...
    public GreatSponsorTrainingEventListData(String online_event_id, String controller_id,String controller, String monitor, String host,
