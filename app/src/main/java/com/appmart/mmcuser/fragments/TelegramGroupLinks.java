...
import com.appmart.mmcuser.adapters.MyCouponListAdapter;
...
import static com.appmart.mmcuser.utils.ServerAddress.GET_TELEGRAM_GROUP_LINKS;
...
public class TelegramGroupLinks extends Fragment {

    private RecyclerView recyclerView;
    private MyCouponListAdapter adapter;
    private List<MyCouponListData> data_list = null;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ((Home) getActivity()).setActionBarTitle("Telegram Group Links");
        ...
        adapter = new MyCouponListAdapter(getContext(), data_list, TelegramGroupLinks.this);
                ...
                try {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        JSONObject object = array.getJSONObject(i);
                            ...
                            MyCouponListData data = new MyCouponListData(object.getString( "tg_id"),
                                    object.getString("group_for"),
                                    object.getString("group_link"));
                            data_list.add(data);
                        }
